...
const Dashboard = () => {
  ...
  const ListData = [
    ...
    {
      id: 9,
      title: "Approved By RA",
      icon: <CheckBoxIcon />,
      to: "/admin/approved-by-ra",
          ...
          <Box>
            <Box sx={{ display: "flex", justifyContent: "center" }}>
              <Avatar
                ...
                sx={{ height: "120px", width: "120px", mt: "2rem" }}
              />
            </Box>
            <Typography
            ...
            <Divider />
            <Box sx={{ p: 1 }}>
              <Typography sx={{ color: "#fff", fontSize: "15px", mt: 1 }}>
                {" "}
                {user.role_name} Dashboard
              </Typography>
              <List component="nav">
                {ListData.map((val) => {
                  return (
                    <>
                      {val.permission == "no_permission" ? null : (
                        <ListItem
                          key={val}
                          disablePadding
                        ...
                        >
                          ...
                          >
                            <ListItemIcon
                              sx={{
                                color:
                                  selectedIndex === val.id ? "black" : "#fff",
                              }}
                            >
                              {val.icon}
                            </ListItemIcon>
